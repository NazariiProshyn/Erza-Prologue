...
const sf::Sprite& SavedGames::getBackground(size_t x, size_t y)
{

    return textureHandler.getSprite(NSTexturePaths::backTexture);
}

const size_t SavedGames::getRaws() const
{
    return NSLvlInfo::raws;
}

const size_t SavedGames::getColumns() const
{
